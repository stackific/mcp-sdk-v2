...
[@stackific/mcp-sdk-ts](../../README.md) / [index](../README.md) / Icon

# Type Alias: Icon

> **Icon** = `z.infer`\<*typeof* [`IconSchema`](../variables/IconSchema.md)\>

Defined in: [types/icon.ts:45](https://github.com/stackific/mcp-sdk-node/blob/main/src/types/icon.ts#L45)
